...
for piloto in pilotos:
	for j in range (1, 6):
		...
		nombre_archivo = f'pruebas_finales/pruebas_lstm_rl/{piloto}/ejecucion_{j}.txt'
		...
		with open("pruebas_finales/pruebas_lstm_rl/global_metrics.json", 'w') as archivo_json:
...
with open('pruebas_finales/pruebas_lstm_rl/metricas_finales.txt', 'w') as file:
