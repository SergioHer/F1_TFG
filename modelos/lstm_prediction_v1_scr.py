...
for piloto in pilotos:
	for j in range (1, 6):
		...
		nombre_archivo = f'pruebas_finales/pruebas_lstm_prediction_v1/{piloto}/ejecucion_{j}.txt'
		...
		with open("pruebas_finales/pruebas_lstm_prediction_v1/global_metrics.json", 'w') as archivo_json:
...
with open('pruebas_finales/pruebas_lstm_prediction_v1/metricas_finales.txt', 'w') as file:
